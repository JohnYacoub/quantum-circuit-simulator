...
![Forks](https://img.shields.io/github/forks/xandrav/quantum-react-frontend?style=social)
![Stars](https://img.shields.io/github/stars/xandrav/quantum-react-frontend?style=social)

<br />
<p align="center">
  <h1 align="center"> Quantum Circuit Simulator</h1>

  <p align="center">
    A web application that allows the user to graphically build quantum circuits and view the results on a dashboard. This project combines React, TypeScript frontend with a Flask, Python backend using Qiskit library to perform <a href="https://github.com/XandraV/quantum-qiskit-flask-backend/blob/master/app/main.py">quantum operations</a>.
    <br />
    <br />
    <a href="https://master.d3vhvy7iyx12n.amplifyapp.com/">View Demo</a> 
  </p>
</p>

<img src='https://general-gif-bucket.s3.eu-west-2.amazonaws.com/quantum.gif' width='100%'/>
